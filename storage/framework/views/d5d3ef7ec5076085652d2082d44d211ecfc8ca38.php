    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#channel-switcher, #locale-switcher').on('change', function (e) {
                ...
                window.location.href = "<?php echo e(route('velocity.admin.meta-data')); ?>" + query;
            })
        });
    </script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin::layouts.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/packages/Webkul/Velocity/src/resources/views/admin/meta-info/meta-data.blade.php ENDPATH**/ ?>