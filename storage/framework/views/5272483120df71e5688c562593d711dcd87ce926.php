    ...
    let tinyMCEHelper = {
        ...
        uploadImageHandler: function(config, blobInfo, success, failure, progress) {
            ...
            xhr.onload = function() {
                ...
                if (xhr.status === 403) {
                    failure('<?php echo e(__('admin::app.error.tinymce.http-error')); ?>', { remove: true });
                    return;
                }

                if (xhr.status < 200 || xhr.status >= 300) {
                    failure('<?php echo e(__('admin::app.error.tinymce.http-error')); ?>');
                    return;
                }
                ...
                if (! json || typeof json.location != 'string') {
                    failure('<?php echo e(__('admin::app.error.tinymce.invalid-json')); ?> ' + xhr.responseText);
                    return;
                }
            ...
            xhr.onerror = function () {
                failure('<?php echo e(__('admin::app.error.tinymce.upload-failed')); ?>');
            };
...
</script><?php /**PATH /Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/packages/Webkul/Admin/src/resources/views/layouts/tinymce.blade.php ENDPATH**/ ?>