        ...
        <div class="page-content">
            ...
            <div class="dashboard-stats">
                ...
                <div class="dashboard-card">
                    ...
                    <a href="<?php echo e(route('admin.sales.orders.index')); ?>">
                        <div class="data">
                ...
                <div class="dashboard-card">
                    <div class="title">
                        <?php echo e(__('admin::app.dashboard.total-unpaid-invoices')); ?>

                    </div>

                    <div class="data">
                        <?php echo e(core()->formatBasePrice($statistics['total_unpaid_invoices'])); ?>
                                        ...
                                        <a href="<?php echo e(route('admin.catalog.categories.edit', $item->category_id)); ?>">
                                            <div class="description">
                                                ...
                                                <div class="info">
                                                    ...
                                                    &nbsp;.&nbsp;
                                                    <?php echo e(__('admin::app.dashboard.sale-count', ['count' => $item->total_qty_invoiced])); ?>
                                ...
                                <li>
                                    <a href="<?php echo e(route('admin.catalog.products.edit', $item->product_id)); ?>">
                                        <div class="product image">
                                            ...
                                            <img class="item-image" src="<?php echo e($productBaseImage['small_image_url'] ?? asset('vendor/webkul/ui/assets/images/product/small-product-placeholder.webp')); ?>" />
                                        </div>
    ...
    <script type="text/x-template" id="date-filter-template">
        <div id="calender-destop">
            <div class="control-group date">
                <date @onChange="applyFilter('start', $event)" hide-remove-button="1"><input type="text" class="control" id="start_date" value="<?php echo e($startDate->format('Y-m-d')); ?>" placeholder="<?php echo e(__('admin::app.dashboard.from')); ?>" v-model="start"/></date>
            </div>

            <div class="control-group date">
                <date @onChange="applyFilter('end', $event)" hide-remove-button="1"><input type="text" class="control" id="end_date" value="<?php echo e($endDate->format('Y-m-d')); ?>" placeholder="<?php echo e(__('admin::app.dashboard.to')); ?>" v-model="end"/></date>
            </div>
        </div>
    </script>
        ...
        <div>
            ...
            <div v-if="toggleCalenderIcon">
                <div id="date-start" style="">
                    ...
                    <label for="type"><?php echo e(__('admin::app.dashboard.from')); ?></label>
                        <date @onChange="setDate('start', $event)" hide-remove-button="1">
                            <input type="text" class="control" id="start_date" value="<?php echo e($startDate->format('Y-m-d')); ?>" placeholder="<?php echo e(__('admin::app.dashboard.from')); ?>" v-model="start"/>
                        </date>
                    </div>
                </div>
                ...
                <div id="date-end" style="">
                    <div class="control-group end-date" style="margin-top:15px">
                        <label for="type"><?php echo e(__('admin::app.dashboard.to')); ?></label>
                        <date @onChange="setDate('end', $event)" hide-remove-button="1">
                            <input type="text" class="control" id="end_date" value="<?php echo e($endDate->format('Y-m-d')); ?>" placeholder="<?php echo e(__('admin::app.dashboard.to')); ?>" v-model="end"/>
                        </date>
                    </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/packages/Webkul/Admin/src/resources/views/dashboard/index.blade.php ENDPATH**/ ?>