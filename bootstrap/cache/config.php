<?php return array (
  ...
  array (
    ...
    'currency' => 'USD',
    'channel' => 'default',
    'key' => 'base64:nquNKPNGHUTqS981Jq8BBllmMp8iUQpx774EgUGYVxg=',
    'cipher' => 'AES-256-CBC',
    'editor' => 'vscode',
    'version' => '1.4.5',
    'debug_blacklist' => 
  ...
  array (
    ...
    'files' => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/routes/breadcrumbs.php',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'file',
        'path' => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/storage/framework/cache/data',
      ),
      'memcached' => 
      array (
        'driver' => 'memcached',
  ...
  array (
    ...
    array (
      ...
      25 => 'Webkul\\Sitemap\\Providers\\ModuleServiceProvider',
    ),
  ),
  'core' => 
  array (
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'local',
        'root' => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/storage/app',
      ),
      'private' => 
      array (
        'driver' => 'local',
        'root' => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/storage/app/private',
      ),
      'public' => 
      array (
        'driver' => 'local',
        'root' => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/storage/app/public',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'single',
        'path' => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/storage/logs/laravel.log',
        'level' => 'debug',
      ),
      'daily' => 
      array (
  ...
  array (
    ...
    array (
      ...
      'paths' => 
      array (
        0 => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/resources/views/vendor/mail',
      ),
    ),
  ),
  'menu' => 
  ...
  array (
    ...
    'encrypt' => false,
    'files' => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/storage/framework/sessions',
    'connection' => 'session',
    'table' => 'sessions',
    'store' => NULL,
    'lottery' => 
  ...
  array (
    ...
    'paths' => 
    array (
      0 => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/resources/views',
    ),
    'compiled' => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/storage/framework/views',
  ),
  'translatable' => 
  array (
    'locales' => 
  ...
  array (
    ...
    array (
      'enabled' => true,
      'driver' => 'file',
      'path' => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/storage/debugbar',
      'connection' => NULL,
      'provider' => '',
      'hostname' => '127.0.0.1',
      'port' => 2304,
  ...
  array (
    ...
    'options' => 
    array (
      'font_dir' => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/storage/fonts',
      'font_cache' => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/storage/fonts',
      'temp_dir' => '/var/folders/x4/7kl512h126q00ktvkgtzwv8w0000gn/T',
      'chroot' => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be',
      'allowed_protocols' => 
      array (
        'file://' => 
        array (
...
',
    ...
    'temporary_files' => 
    array (
      'local_path' => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/storage/framework/cache/laravel-excel',
      'remote_disk' => NULL,
      'remote_prefix' => NULL,
  ...
  array (
    ...
    'remote_sites_path' => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be',
    'local_sites_path' => '',
  ...
  array (
    ...
    'paths' => 
    array (
      0 => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/public/upload',
      1 => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/public/images',
    ),
    'templates' => 
    array (
  ...
  array (
    ...
    'generator' => 
    array (
      'basePath' => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/app',
      'rootNamespace' => 'App\\',
      'stubsOverridePath' => '/Applications/MAMP/htdocs/bagisto-bagisto-ac6a4be/app',
      'paths' => 
      array (
        'models' => 'Entities',
